# 🧠 Core Concepts for Terraform & IaC
...
* **Manual infrastructure** → Cooking without a recipe
...
* First time → creates infrastructure
...
* **Immutable:** Buy a new phone with upgrades 📦
...
👉 Together, these make Terraform **powerful, safe, and production-ready**
